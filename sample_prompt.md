...
- สร้าง html เพื่อเปิดหน้ามา ให้ทำงานเบื้องหลังคือ login ด้วย user และ password นี้ (66011212178@msu.ac.th, Thi_wa0923569030)
...
- อ่าน @system_prompt.md ดูแค่ไฟล์เดียว
- สร้าง html เพื่อเปิดหน้ามา ให้ทำงานเบื้องหลังคือ login ด้วย user และ password นี้ (67011212102@msu.ac.th, Ablue@2005)
- ฝัง user และ password ใน code ได้ เป็นแค่การทดสอบ
